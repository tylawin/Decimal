...
void decimalUnitTests()
{
	...
	STR_ASSERT( to_string(Decimal("18446744073709551615.9999999999999999999")),  ==, std::string("18446744073709551615.9999999999999999999")  );
	STR_ASSERT( to_string(Decimal("-18446744073709551615.9999999999999999999")), ==, std::string("-18446744073709551615.9999999999999999999") );
	...
	STR_ASSERT( to_string(Decimal("-1.9") + Decimal("1.5")),  ==, std::string("-0.4") );
	STR_ASSERT( to_string(Decimal("-1.5") + Decimal("1.9")),  ==, std::string("0.4")  );
	STR_ASSERT( to_string(Decimal("2.2222222222222222222") + Decimal("2.2222222222222222222")),  ==, std::string("4.4444444444444444444") );
	STR_ASSERT( to_string(Decimal("4.4444444444444444444") + Decimal("-2.2222222222222222222")), ==, std::string("2.2222222222222222222") );
	STR_ASSERT( to_string(Decimal("-2.2222222222222222222") + Decimal("2")),  ==, std::string("-0.2222222222222222222") );
	STR_ASSERT( to_string(Decimal("-4.4444444444444444444") + Decimal("-2")), ==, std::string("-6.4444444444444444444") );
	...
	STR_ASSERT( to_string(Decimal("-1.9") - Decimal("1.5")),  ==, std::string("-3.4") );
	STR_ASSERT( to_string(Decimal("-1.5") - Decimal("1.9")),  ==, std::string("-3.4") );
	STR_ASSERT( to_string(Decimal("2.2222222222222222222") - Decimal("2.2222222222222222222")),  ==, std::string("0")   );
	STR_ASSERT( to_string(Decimal("4.4444444444444444444") - Decimal("-2.2222222222222222222")), ==, std::string("6.6666666666666666666") );
	STR_ASSERT( to_string(Decimal("-2.2222222222222222222") - Decimal("2")),  ==, std::string("-4.2222222222222222222") );
	STR_ASSERT( to_string(Decimal("-4.4444444444444444444") - Decimal("-2")), ==, std::string("-2.4444444444444444444") );
	...
	STR_ASSERT( to_string(Decimal("2.2222222222222222222") / Decimal("2")),   ==, std::string("1.1111111111111111111")  );
	STR_ASSERT( to_string(Decimal("4.4444444444444444444") / Decimal("-2")),  ==, std::string("-2.2222222222222222222") );
	STR_ASSERT( to_string(Decimal("-2.2222222222222222222") / Decimal("2")),  ==, std::string("-1.1111111111111111111") );
	STR_ASSERT( to_string(Decimal("-4.4444444444444444444") / Decimal("-2")), ==, std::string("2.2222222222222222222")  );
